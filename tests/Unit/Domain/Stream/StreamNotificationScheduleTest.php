...
final class StreamNotificationScheduleTest extends TestCase
{
    ...
    #[Test]
    public function itSelectsEndedNotificationForAnEndedVideo(): void
    {
        $video = new PlatformVideo('01990d4a-0000-7000-8000-000000000801', '01990d4a-0000-7000-8000-000000000802', 'abcdefghijk', '配信', new DateTimeImmutable('2026-09-09T00:00:00Z'), null, new DateTimeImmutable('2026-09-09T00:00:00Z'), new DateTimeImmutable('2026-09-09T01:00:00Z'), null, 'ended', new DateTimeImmutable('2026-09-09T01:00:00Z'));

        self::assertSame([StreamNotificationType::Ended], (new StreamNotificationSchedule())->due($video, new DateTimeImmutable('2026-09-09T01:00:00Z')));
    }
