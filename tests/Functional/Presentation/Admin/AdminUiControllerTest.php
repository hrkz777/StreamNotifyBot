...
final class AdminUiControllerTest extends WebTestCase
{
    ...
    public function streamerPageProvidesDatabaseRegistrationForm(): void
    {
        ...
        self::assertSelectorExists('#streamer-edit-dialog form[action="/admin/streamers/accounts"]');
        self::assertSelectorExists('#streamer-edit-dialog input[name="streamer_id"][data-streamer-edit-account-streamer-id]');
